"""
union-net test cifar10, best to 0.9533.
"""
...
opt = optimizers.Nadam(lr=0.01, beta_1=0.5, beta_2=0.999, epsilon=1e-08, schedule_decay=0.004)
reg=0.0001
...
#model.fit(X_train, Y_train,  batch_size=batch_size, nb_epoch=nb_epoch, validation_data=(X_test, Y_test),shuffle=True, callbacks=[lr_reducer, early_stopper])
