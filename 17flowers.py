...
my_input = Input(shape=(100,100,3),name='my_input')
...
#m3 = layers.MaxPooling2D(2)(m3)
n1=layers.Conv2D(128, 1, padding='same')(m11)
n2=layers.Conv2D(128, 1, padding='same')(m22)
...
reduce_lr = ReduceLROnPlateau(monitor='val_accuracy', factor=0.8, patience=2, verbose=1, mode='min', epsilon=0.0001, cooldown=0, min_lr=0)
# 绘制训练过程中的损失曲线和精度曲线
...
H = model.fit_generator(
	trainGen,
	steps_per_epoch=totalTrain*3 // BS,
